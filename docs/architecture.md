...
```
src/models/
├── model_loader.py       # Model, tokenizer, and processor loading
└── wrapper.py           # Model wrapper with coordinate token support
```

**Purpose**: Model loading and coordinate token integration
**Key Features**:
...
**Purpose**: Training orchestration and monitoring
**Key Features**:
