...
class ImageProcessor:
    ...
    def update_output_coordinates(self) -> bool:
        ...
        """
        if not self.config.resize or not self.output_image_dir:
        ...
        for json_file in json_files:
            try:
                ...
                if self._needs_coordinate_scaling(data, output_size):
                    ...
                    # Scale coordinates
                    features_updated = self._scale_json_coordinates(
    ...
    def _needs_coordinate_scaling(
        self, data: Dict, output_size: Tuple[int, int]
    ) -> bool:
    ...
    def _scale_json_coordinates(
        self, data: Dict, scale_x: float, scale_y: float
    ) -> int:
