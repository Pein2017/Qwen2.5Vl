...
class EnhancedRLConfig:
    ...
    def from_yaml_dict(cfg: Dict[str, Any]) -> "EnhancedRLConfig":
        ...
        return EnhancedRLConfig(
            ...
            coordinate_tokens_enabled=model_cfg.get("coordinate_tokens_enabled", False),
            max_coord_value=model_cfg.get("max_coord_value", 8192),
            ...
            # Output configuration
            output_dir=output_cfg.get("output_dir", "/data3/Qwen2.5-VL-main/outputs/rl_enhanced_grpo"),
    ...
    def to_hf_training_args(self) -> Dict[str, Any]:
        ...
        if self.checkpoint_config.resume_from_checkpoint:
            args["resume_from_checkpoint"] = self.checkpoint_config.resume_from_checkpoint
    ...
    def setup_logging(self) -> None:
        ...
        logging.getLogger("src_rl").setLevel(log_level)
