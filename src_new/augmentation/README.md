...
- Type‑aware object‑level ops (planned): cut/move with inpaint, copy‑paste with alpha feather, masked object blur — see `src_new/augmentation/bbu_specialized_plan.md`.
