...
from src_new.augmentation.object_registry import resolve_object_type
from src_new.augmentation.standardize import validate_sample_after_transform
from src_new.config.augmentation_config import CriteriaConfig
