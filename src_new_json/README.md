...
- Dynamic contrastive pairing (training only)
  ...
  - `dynamic_pair_candidate_pool_size: 128`, `dynamic_pair_max_teacher_uses_per_epoch: 5`, `dynamic_pair_temperature: 0.7` (placeholders; sampling is uniform random in‑bucket)
- Geometry/vision
